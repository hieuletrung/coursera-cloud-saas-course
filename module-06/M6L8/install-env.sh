...
cd /home/ubuntu
sudo -u ubuntu npm install @aws-sdk/client-sqs @aws-sdk/client-s3 @aws-sdk/client-sns express multer multer-s3 uuid ip @aws-sdk/client-dynamodb
...
cd /home/ubuntu/coursera-cloud-saas-course/module-06/M6L8

sudo cp /home/ubuntu/coursera-cloud-saas-course/module-06/M6L8/default /etc/nginx/sites-available/default
